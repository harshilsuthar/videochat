$(".menu a i").on("click", function () {
    ...
    $(document).on("click", "#contact, #recipient", function () {
        $(this).remove();
    }),
    ...
    $(document).ready(function () {
        $(".filterMembers").not(".all").hide("3000"),
            $(".filterMembers").not(".all").hide("3000"),
            $(document).on("click",".filterMembersBtn", function () {
    ...
    $(document).ready(function () {
        $(".filterDiscussions").not(".all").hide("3000"),
            $(".filterDiscussions").not(".all").hide("3000"),
            $(document).on("click",".filterDiscussionsBtn", function () {
                var t = $(this).attr("data-filter");
                $(".filterDiscussions")
                    .not("." + t)
                    .hide("3000"),
    ...
    $(document).ready(function () {
        $(".filterNotifications").not(".all").hide("3000"),
            $(".filterNotifications").not(".all").hide("3000"),
            $(document).on("click", ".filterNotificationsBtn", function () {
                var t = $(this).attr("data-filter");
                $(".filterNotifications")
                    .not("." + t)
                    .hide("3000"),
    ...
    $(document).ready(function () {
        (clicked = !0),
            $(document).on("click", ".mode", function () {
                clicked
                    ? ($("head").append(
                          '<link href="/static/css/dark.min.css" id="dark" type="text/css" rel="stylesheet">'
                      ),
                      (clicked = !1))
