...
urlpatterns = [
    ...
    path("get_room_or_send_invitation/", views.get_room_or_send_invitation, name="GetRoomOrSendInvitation"),
    ...
    path("group_member_add_list/", views.group_member_add_list, name="GroupMemberAddList"),
