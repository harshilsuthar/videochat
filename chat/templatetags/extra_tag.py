...
from chat.models.roomchat import Room, RoomMember
    ...
    try:
        ...
        if timedelta.days >= 365:
            if timedelta.days//365 == 1:
                ...
                return "%d years ago".format(timedelta.days//365)
...
def get_room_member_id(room_id, user_id):
    try:
        current_room_member = RoomMember.objects.get(member__id=user_id, room__id=room_id)
